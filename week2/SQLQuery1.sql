CREATE DATABASE CUSTOMERS_SALES_DATA;
GO

USE CUSTOMERS_SALES_DATA;
GO
...
--Clustered Indexing
CREATE CLUSTERED INDEX idx_ProductPrice ON Products(Price);

--CompositeIndexing
CREATE NONCLUSTERED INDEX idx_CustomerOrderDate ON Orders(CustomerID, OrderDate);
